...
function getLados(l1, l2, l3){
    ...
    var area = Math.sqrt(semiperimetro * (semiperimetro-l1) * (semiperimetro-l2) * (semiperimetro-l3));
...
function getNumber(a, b, c, d, e) {
    var num = a.substring(0, 1) + b.substring(1, 2) + c.substring(2, 3) + d.substring(3, 4) + e.substring(4, 5);
    
    document.getElementById('respuesta2').value = num;
};

function validateNumber(a, b, c, d, e) {
    if (a <= 9999 || b <= 9999 || c <= 9999 || d <= 9999 || e <= 9999 || a > 99999 || b > 99999 || c > 99999 || d > 99999 || e > 99999) {
